...
const glav        = 1632498079//id главного админа
var   admid       = [] //id доп. админов через запятую
const token       = "1823267135:AAFrQo_ptxSH3yTtDuNJoOZop9FGPwwsxh8"//токен бота
...
t.on('message', async (msg)=> {
  ...
  if(command(['start', 'help', 'помощь'])) {
    ...
    text.push(`\nВсе обновления выкладываются в телеграм канал бота: https://t.me/OverLAm`)
    reply(text.join ("\n"));
  }
